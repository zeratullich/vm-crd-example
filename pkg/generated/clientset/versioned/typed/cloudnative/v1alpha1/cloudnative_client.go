...
import (
	...
	"vm-crd-create/pkg/generated/clientset/versioned/scheme"
...
// CloudnativeV1alpha1Client is used to interact with features provided by the cloudnative.lich group.
...
// NewForConfigAndClient creates a new CloudnativeV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CloudnativeV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
