...
import (
	"context"
	time "time"
	cloudnativev1alpha1 "vm-crd-create/pkg/apis/cloudnative/v1alpha1"
	versioned "vm-crd-create/pkg/generated/clientset/versioned"
	internalinterfaces "vm-crd-create/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "vm-crd-create/pkg/generated/listers/cloudnative/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudnativeV1alpha1().VirtualMachines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudnativeV1alpha1().VirtualMachines(namespace).Watch(context.TODO(), options)
			},
		},
